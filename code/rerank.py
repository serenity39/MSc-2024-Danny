...
model_path = "../data/results/models/early_stopping/shallow_based_2500_2"
...
run_file_path = (
    "../data/results/runs/early_stopping/shallow_based_2500_2_run.txt"
)
run_name = "es_shallow_based_2500_2"
